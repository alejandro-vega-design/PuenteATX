...
import CrossCountyHeatmap from './CrossCountyHeatmap';
...
export default function AdminInsights({ lang, locationSearch, navigate }) {
  ...
  return <div className="admin-insights-page">
    ...
    <div className="insights-grid">
      ...
      <Panel title={t.crossCounty} source={t.sourceEvents} updated={updated} className="insights-panel-full insights-cross-county-panel"><CrossCountyHeatmap data={snapshot?.cross_county} t={t}/></Panel>
