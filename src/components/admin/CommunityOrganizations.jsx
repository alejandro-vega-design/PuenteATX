...
export default function CommunityOrganizations({ session, lang, notify }) {
  ...
  return <section className="community-page organization-access-page">
    ...
    {state === 'loading' && <div className="organization-access-loading" aria-live="polite"><span className="loading-inline"><span className="admin-button-spinner" aria-hidden="true"/><span>{es ? 'Cargando usuarios…' : 'Loading users…'}</span></span></div>}
