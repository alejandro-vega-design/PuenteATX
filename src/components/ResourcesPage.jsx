...
export default function ResourcesPage({ lang, t, locationSearch, navigate, savedSlugs = [], onToggleSaved }) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const result = await getPublishedResources(filters, lang);
      setResources(result);
      if (shouldTrack) {
