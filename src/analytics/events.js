...
const EVENT_FIELDS = {
  ...
  resource_viewed: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  resource_selected: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  resource_saved: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  resource_removed: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  call_clicked: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  whatsapp_clicked: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  website_clicked: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
  directions_clicked: { required: ['resource_id'], optional: ['category_slug', 'area_code'] },
